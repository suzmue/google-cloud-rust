...
impl<T: super::PredictionService> PredictionService for T {
    ...
    async fn stream_direct_predict(
        ...
        T::stream_direct_predict(self, options).await
    }
    ...
    async fn stream_direct_raw_predict(
        ...
        T::stream_direct_raw_predict(self, options).await
    }
    ...
    async fn streaming_predict(
        ...
        T::streaming_predict(self, options).await
    }
    ...
    async fn streaming_raw_predict(
        ...
        T::streaming_raw_predict(self, options).await
    }
