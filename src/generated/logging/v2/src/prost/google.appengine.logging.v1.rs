...
impl ::prost::Name for LogLine {
    const NAME: &'static str = "LogLine";
    const PACKAGE: &'static str = "google.appengine.logging.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "google.appengine.logging.v1.LogLine".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "type.googleapis.com/google.appengine.logging.v1.LogLine".into()
    }
}
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
...
impl ::prost::Name for SourceLocation {
    const NAME: &'static str = "SourceLocation";
    const PACKAGE: &'static str = "google.appengine.logging.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "google.appengine.logging.v1.SourceLocation".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "type.googleapis.com/google.appengine.logging.v1.SourceLocation".into()
    }
}
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
...
impl ::prost::Name for SourceReference {
    const NAME: &'static str = "SourceReference";
    const PACKAGE: &'static str = "google.appengine.logging.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "google.appengine.logging.v1.SourceReference".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "type.googleapis.com/google.appengine.logging.v1.SourceReference".into()
    }
}
...
impl ::prost::Name for RequestLog {
    const NAME: &'static str = "RequestLog";
    const PACKAGE: &'static str = "google.appengine.logging.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "google.appengine.logging.v1.RequestLog".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "type.googleapis.com/google.appengine.logging.v1.RequestLog".into()
    }
}
