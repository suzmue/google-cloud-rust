...
pub mod attribute_context {
    ...
    impl ::prost::Name for Peer {
        ...
        fn type_url() -> ::prost::alloc::string::String {
            "type.googleapis.com/google.rpc.context.AttributeContext.Peer".into()
        }
    }
    ...
    impl ::prost::Name for Api {
        ...
        fn type_url() -> ::prost::alloc::string::String {
            "type.googleapis.com/google.rpc.context.AttributeContext.Api".into()
        }
    }
    #[derive(Clone, PartialEq, ::prost::Message)]
    pub struct Auth {
    ...
    impl ::prost::Name for Auth {
        ...
        fn type_url() -> ::prost::alloc::string::String {
            "type.googleapis.com/google.rpc.context.AttributeContext.Auth".into()
        }
    }
    #[derive(Clone, PartialEq, ::prost::Message)]
    pub struct Request {
    ...
    impl ::prost::Name for Request {
        ...
        fn type_url() -> ::prost::alloc::string::String {
            "type.googleapis.com/google.rpc.context.AttributeContext.Request".into()
        }
    }
    #[derive(Clone, PartialEq, ::prost::Message)]
    pub struct Response {
    ...
    impl ::prost::Name for Response {
        ...
        fn type_url() -> ::prost::alloc::string::String {
            "type.googleapis.com/google.rpc.context.AttributeContext.Response".into()
        }
    }
    #[derive(Clone, PartialEq, ::prost::Message)]
    pub struct Resource {
    ...
    impl ::prost::Name for Resource {
        ...
        fn type_url() -> ::prost::alloc::string::String {
            "type.googleapis.com/google.rpc.context.AttributeContext.Resource".into()
        }
    }
}
impl ::prost::Name for AttributeContext {
    ...
    fn type_url() -> ::prost::alloc::string::String {
        "type.googleapis.com/google.rpc.context.AttributeContext".into()
    }
}
