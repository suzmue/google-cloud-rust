...
/// # Example
/// ```
/// # use google_cloud_pubsub_bidi_test::client::Publisher;
/// async fn sample(
///    project_id: &str,
///    topic_id: &str,
/// ) -> anyhow::Result<()> {
...
impl Publisher {
    ...
    /// ```
    /// # use google_cloud_pubsub_bidi_test::client::Publisher;
    /// use google_cloud_pubsub_bidi_test::Result;
    /// async fn sample(
    ///    client: &Publisher
    /// ) -> Result<()> {
    ...
    /// use google_cloud_pubsub_bidi_test::Result;
    /// async fn sample(
    ///    client: &Publisher, project_id: &str, topic_id: &str
    /// ) -> Result<()> {
    ...
    ///    client: &Publisher
    /// ) -> Result<()> {
    ///     let response = client.list_topic_subscriptions()
    ///         /* set fields */
    ///         .send().await?;
    ///     println!("response {:?}", response);
    ///     Ok(())
...
/// [with_credentials()]: super::builder::subscriber::ClientBuilder::with_credentials
/// [Private Google Access with VPC Service Controls]: https://cloud.google.com/vpc-service-controls/docs/private-connectivity
/// [Application Default Credentials]: https://cloud.google.com/docs/authentication#adc
///
/// # Pooling and Cloning
...
/// create one and reuse it. You do not need to wrap `Subscriber` in
/// an [Rc](std::rc::Rc) or [Arc](std::sync::Arc) to reuse it, because it
/// already uses an `Arc` internally.
#[derive(Clone, Debug)]
...
impl Subscriber {
    ...
    pub fn builder() -> super::builder::subscriber::ClientBuilder {
        crate::new_client_builder(super::builder::subscriber::client::Factory)
    }
    ...
    /// use google_cloud_pubsub_bidi_test::Result;
    /// async fn sample(
    ///    client: &Subscriber, project_id: &str, subscription_id: &str
    /// ) -> Result<()> {
    ///     let response = client.get_subscription()
    ///         .set_subscription(format!("projects/{project_id}/subscriptions/{subscription_id}"))
    ///         .send().await?;
    ...
    /// use google_cloud_pubsub_bidi_test::Result;
    /// async fn sample(
    ///    client: &Subscriber, project_id: &str, snapshot_id: &str
    /// ) -> Result<()> {
...
/// # Example
/// ```
/// # use google_cloud_pubsub_bidi_test::client::SchemaService;
/// use google_cloud_gax::paginator::ItemPaginator as _;
/// async fn sample(
///    parent: &str,
/// ) -> anyhow::Result<()> {
