    ...
    async fn publish(
        ...
        let (builder, method, _path_template, _resource_name) = None
            .or_else(|| {
                ...
                let path = format!("/v1/{}:publish", var_topic,);
                let path_template = "/v1/{topic}:publish";
...
impl std::fmt::Debug for Subscriber {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::result::Result<(), std::fmt::Error> {
        let mut builder = f.debug_struct("Subscriber");
...
impl super::stub::Subscriber for Subscriber {
    ...
    async fn modify_ack_deadline(
        ...
        let (builder, method, _path_template, _resource_name) = None
            .or_else(|| {
                ...
                let path = format!("/v1/{}:modifyAckDeadline", var_subscription,);
                let path_template = "/v1/{subscription}:modifyAckDeadline";
    ...
    async fn acknowledge(
        ...
        let (builder, method, _path_template, _resource_name) = None
            .or_else(|| {
                ...
                let path = format!("/v1/{}:acknowledge", var_subscription,);
                let path_template = "/v1/{subscription}:acknowledge";
    ...
    async fn pull(
        ...
        let (builder, method, _path_template, _resource_name) = None
            .or_else(|| {
                ...
                let path = format!("/v1/{}:pull", var_subscription,);
                let path_template = "/v1/{subscription}:pull";
        ...
        if let Some(recorder) = gaxi::observability::RequestRecorder::current() {
            recorder.on_client_request(
                gaxi::observability::ClientRequestAttributes::default()
                    .set_rpc_method("google.pubsub.v1.Subscriber/Pull")
                    .set_url_template(_path_template)
                    .set_resource_name(_resource_name),
            );
        }
    ...
    async fn streaming_pull(
        ...
        let (req_tx, mut req_rx) =
            tokio::sync::mpsc::channel::<crate::model::StreamingPullRequest>(100);
        let (resp_tx, resp_rx) =
            tokio::sync::mpsc::channel::<crate::Result<crate::model::StreamingPullResponse>>(100);
        ...
        tokio::spawn(async move {
            ...
            let result = grpc_client
                .bidi_stream::<
                    crate::prost::google::pubsub::v1::StreamingPullRequest,
                    crate::prost::google::pubsub::v1::StreamingPullResponse,
                >(
                    extensions,
                    path,
                    req_stream,
