...
impl super::stub::Echo for Echo {
    ...
    async fn chat(
        ...
        if capacity == 0 || capacity > google_cloud_gax::options::MAX_REQUEST_CHANNEL_CAPACITY {
            return Err(google_cloud_gax::error::Error::binding(format!(
                "request channel capacity must be between 1 and {}",
                google_cloud_gax::options::MAX_REQUEST_CHANNEL_CAPACITY
            )));
        }
