...
pub struct BenchmarkStats {
    ...
    pub total_rpc_requests: Option<u64>,
    pub hedged_rpc_requests: Option<u64>,
}
...
impl BenchmarkStats {
    pub fn print_summary(&mut self) {
        ...
        if let (Some(total_rpcs), Some(hedged_rpcs)) =
            (self.total_rpc_requests, self.hedged_rpc_requests)
        {
