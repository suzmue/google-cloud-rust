...
pub enum ChecksumMismatch {
    ...
    Crc32c {
        /// The value computed by the client.
        got: u32,
        /// The value received from the service.
        want: u32,
    },
    ...
    Both {
        /// The values computed by the client.
        got: Box<ObjectChecksums>,
        /// The values received from the service.
...
pub enum WriteError {
    ...
    UnexpectedRewind {
        /// The number of bytes previously reported as persisted.
        offset: u64,
        /// The number of bytes now reported as persisted.
        persisted: u64,
    },
    ...
    ChecksumMismatch {
        ...
        /// The object that was being uploaded.
        object: Box<Object>,
    },
}
...
impl SigningError {
    ...
    /// Returns true if the error was caused by an invalid parameter.
