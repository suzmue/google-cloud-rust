...
async fn probe_speech_v2(delay_dur: Duration) {
    ...
    let req = StreamingRecognizeRequest::default().set_recognizer("projects/suzmue-testing/locations/global/recognizers/_");
    let stream = DelayedStream::new(delay_dur, req);
...
async fn probe_aiplatform_streaming_predict(delay_dur: Duration) {
    ...
    let req = StreamingPredictRequest::default().set_endpoint("projects/suzmue-testing/locations/us-central1/endpoints/probe");
    let stream = DelayedStream::new(delay_dur, req);
...
async fn probe_aiplatform_streaming_raw_predict(delay_dur: Duration) {
    ...
    let req = StreamingRawPredictRequest::default().set_endpoint("projects/suzmue-testing/locations/us-central1/endpoints/probe");
    let stream = DelayedStream::new(delay_dur, req);
...
async fn probe_aiplatform_stream_direct_predict(delay_dur: Duration) {
    ...
    let req = StreamDirectPredictRequest::default().set_endpoint("projects/suzmue-testing/locations/us-central1/endpoints/probe");
    let stream = DelayedStream::new(delay_dur, req);
...
async fn probe_aiplatform_stream_direct_raw_predict(delay_dur: Duration) {
    ...
    let req = StreamDirectRawPredictRequest::default().set_endpoint("projects/suzmue-testing/locations/us-central1/endpoints/probe");
    let stream = DelayedStream::new(delay_dur, req);
...
async fn probe_aiplatform_feature_view_direct_write(delay_dur: Duration) {
    ...
    let req = FeatureViewDirectWriteRequest::default().set_feature_view("projects/suzmue-testing/locations/us-central1/featureOnlineStores/fos/featureViews/fv");
    let stream = DelayedStream::new(delay_dur, req);
...
async fn probe_discoveryengine_v1(delay_dur: Duration) {
    ...
    let req = GenerateGroundedContentRequest::default().set_location("projects/suzmue-testing/locations/global");
    let stream = DelayedStream::new(delay_dur, req);
...
async fn probe_modelarmor_user_prompt(delay_dur: Duration) {
    ...
    let req = SanitizeUserPromptRequest::default().set_name("projects/suzmue-testing/locations/global/templates/probe");
    let stream = DelayedStream::new(delay_dur, req);
...
async fn probe_modelarmor_model_response(delay_dur: Duration) {
    ...
    let req = SanitizeModelResponseRequest::default().set_name("projects/suzmue-testing/locations/global/templates/probe");
    let stream = DelayedStream::new(delay_dur, req);
...
async fn probe_dialogflow_cx_v3(delay_dur: Duration) {
    ...
    let req = StreamingDetectIntentRequest::default().set_session("projects/suzmue-testing/locations/global/agents/probe/sessions/probe");
    let stream = DelayedStream::new(delay_dur, req);
...
async fn probe_dialogflow_v2_sessions(delay_dur: Duration) {
    ...
    let req = StreamingDetectIntentRequest::default().set_session("projects/suzmue-testing/agent/sessions/probe");
    let stream = DelayedStream::new(delay_dur, req);
...
async fn probe_dialogflow_v2_participants(delay_dur: Duration) {
    ...
    let req = StreamingAnalyzeContentRequest::default().set_participant("projects/suzmue-testing/locations/global/conversations/probe/participants/probe");
    let stream = DelayedStream::new(delay_dur, req);
